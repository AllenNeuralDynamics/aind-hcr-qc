...
def setup_argument_parser():
    ...
    parser.add_argument(
        ...
        help="S3 bucket name for data access"
    )
    ...
    qc_group.add_argument(
        ...
        action="store_true", 
        default=False,
        help="Run tile alignment QC analysis"
    )
    qc_group.add_argument(
        "--camera-alignment", 
        action="store_true", 
        default=False,
        help="Run camera alignment QC analysis"
    )
    qc_group.add_argument(
        "--segmentation", 
        action="store_true", 
        default=False,
        help="Run segmentation QC analysis"
    )
    qc_group.add_argument(
        "--round-to-round", 
        action="store_true", 
        default=False,
        help="Run round-to-round QC analysis"
    )
    qc_group.add_argument(
        "--spectral-unmixing", 
        action="store_true", 
        default=False,
        help="Run spectral unmixing QC analysis"
    )
    qc_group.add_argument(
        "--spot-detection", 
        action="store_true", 
        default=False,
        help="Run spot detection QC analysis"
    )
    qc_group.add_argument(
        "--all", 
        action="store_true", 
